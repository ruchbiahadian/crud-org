<template>
    <Form @submit="submitFormOrg">
        ...
        <div class="columns">
            <span class="column is-one-fifth is-flex is-justify-content-start">Gambar</span>
            <Field name="form.imageUrl" rules="required" v-slot="{ field, errors }" :model-value="form.imageUrl">
                <b-input
                    size="is-small"
                    v-bind="field"
                    class="column"
